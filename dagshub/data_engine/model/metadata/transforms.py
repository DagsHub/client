...
from dagshub.data_engine.model.metadata.util import wrap_bytes, _get_datetime_utc_offset
...
def _add_metadata(
    ...
    def _generate_metadata_update_entry(val: Any, is_multivalue: bool) -> Optional[DatapointMetadataUpdateEntry]:
        value_type = field_info.field_value_types.get(key)
        tz = None
        if value_type is None:
            value_type = metadata_type_lookup[type(val)]
            field_info.field_value_types[key] = value_type
