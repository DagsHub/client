...
class Datasource:
    ...
    def log_to_mlflow(
        ...
        client.set_tag(run.info.run_id, MLFLOW_DATASOURCE_TAG_NAME, str(self.source.id))
        if self.assigned_dataset is not None:
            client.set_tag(run.info.run_id, MLFLOW_DATASET_TAG_NAME, str(self.assigned_dataset.dataset_id))
