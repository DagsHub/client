...
from dagshub.data_engine.annotation.voxel_conversion import add_ls_annotations
                ...
                if type(val) is list:
                    ...
                    for sub_val in val:
                        res.append(DatapointMetadataUpdateEntry(
                            ...
                            key=key,
                            value=str(sub_val),
                            valueType=_metadataTypeLookup[type(sub_val)],
                            allowMultiple=True
                        ))
                else:
                    res.append(DatapointMetadataUpdateEntry(
    ...
    def to_voxel51_dataset(self, **kwargs) -> "fo.Dataset":
        ...
        with progress:
            for datapoint in datapoints.entries:
                ...
                add_ls_annotations(sample, datapoint, *self.annotation_columns)
