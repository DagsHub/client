...
# Note: This is a terrible model architecture with bad pracices, meant only to demonstrate and test the DAGsHubLogger callback
...
model = Sequential([Input((28, 28, 1)), Conv2D(10, 3, activation='relu'), Flatten(), Dense(20, activation='relu'), Dense(10)])
